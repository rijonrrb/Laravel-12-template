                            ...
                            <form action="{{ route('admin.settings.general_store') }}" method="post"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('Dimensional Factor') }}</label>
                                                <input type="number" step="0.01" min="1" class="form-control" name="dimensional_factor"
                                                    value="{{ $settings->dimensional_factor }}"
                                                    placeholder="{{ __('Dimensional Factor') }}...">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
